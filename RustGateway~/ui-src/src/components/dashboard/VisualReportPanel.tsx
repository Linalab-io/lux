    ...
    <div className="panel-container">
      <div className="panel-card">
        ...
        {status === 'done' && matchPercentage !== null && (
          <div style={{ marginBottom: '24px', padding: '16px', backgroundColor: matchPercentage > 95 ? 'rgba(52, 211, 153, 0.1)' : 'rgba(251, 113, 133, 0.1)', border: `1px solid ${matchPercentage > 95 ? 'var(--green)' : 'var(--red)'}`, borderRadius: '6px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
