...
| プロジェクト | URL | 目的 |
| :--- | :--- | :--- |
| Unity-MCP | https://github.com/IvanMurzak/Unity-MCP | Unity Editor ↔ MCP統合リファレンス; シーン/アセット/ビルド自動化ツールインベントリ |
| Unity AI Assistant | https://docs.unity3d.com/Packages/com.unity.ai.assistant | 公式Unity AIアシスタントフレームワーク; エディター自動化API |
| unity-cli-loop | https://github.com/hatayama/unity-cli-loop | 元のuloopリファレンスプロジェクト (346 ⭐); CLIパリティベースライン |
