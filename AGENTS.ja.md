...
| `Addons/unity-git/` | Git統合アドオン | `Linalab.UnityGit.Editor` |
| `Addons/codex-image/` | 画像生成パイプラインアドオン | C#エディタースクリプト |
| `Addons/pipeline-editor/` | ビジュアルパイプラインエディターアドオン | C#エディタースクリプト |
